...
async def get_mapbox_image(
    ...
    width: int = Query(
        800, ge=1, le=1280, description="Width of the image in pixels (max 1280)"
    ),
    height: int = Query(
        800, ge=1, le=1280, description="Height of the image in pixels (max 1280)"
    ),
